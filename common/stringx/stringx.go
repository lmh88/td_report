...
// TransferHumpString 大驼峰
func TransferHumpString(str, spet string) string {
	str = strings.Replace(str, spet, " ", -1)
	str = strings.ToTitle(str)
	return strings.Replace(str, " ", "", -1)
}

// TransferHumpStringSmall 小驼峰
func TransferHumpStringSmall(str, spet string) string {
	str = TransferHumpString(str, spet)
