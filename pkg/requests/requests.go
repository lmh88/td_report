// copy from https://github.com/FastSchnell/Teheran v1.0.1
...
func newRequestWithoutPool(url, method string, arg ...fakeArgs) (*Resp, error) {
	fmt.Println("with no pool==========", "method", method, "url:", url)
	var (
		err      error
		body     io.Reader
		jsonVal  []byte
...
func (cls *Resp) JsonAndValueIsAny() (val map[string]interface{}, err error) {
	err = goJson.Unmarshal(cls.Body, &val)
	return
}
