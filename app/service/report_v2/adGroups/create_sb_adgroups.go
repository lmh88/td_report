...
func CreateSbAdGroupsReport(profileMsg *varible.ProfileMsg, ctx context.Context) (string, error) {
	reportType := "adGroups"
	segment := ""
	creativeType := "all"
...
func CreateSbAdGroupsVideoReport(profileMsg *varible.ProfileMsg, ctx context.Context) (string, error) {
	reportType := "adGroups"
	segment := ""
	creativeType := "video"
